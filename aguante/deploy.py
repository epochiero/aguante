...
class Task():
    ...
    def get_full_cmd(self, cmd):
        ...
        if virtualenv:
            full_cmd += "source /home/django/.virtualenvs/%s/bin/activate; " % (
                virtualenv)
